...
const DigitalSerenity = () => {
  const [mouseGradientStyle, setMouseGradientStyle] =
    useState<MouseGradientStyle>({
      left: "0px",
      top: "0px",
      opacity: 0,
    });
  ...
  useEffect(() => {
    const animateWords = () => {
      const wordElements = document.querySelectorAll<HTMLElement>(
        ".word-animate"
      );
  ...
  useEffect(() => {
    ...
    const handleWordEnter = (e: MouseEvent) => {
